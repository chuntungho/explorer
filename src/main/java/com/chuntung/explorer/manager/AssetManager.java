...
public class AssetManager {
    ...
    public Mono<ServerResponse> getAsset(String path) {
        return Mono.fromCallable(() -> {
            ...
            ServerResponse.BodyBuilder bodyBuilder = ServerResponse.ok().contentType(contentType);
...
//            }
            ...
            return bodyBuilder.bodyValue(new InputStreamResource(in));
        }).flatMap(response -> (Mono<ServerResponse>) response);
    }
}
